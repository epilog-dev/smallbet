...
- Pricing-intent: variant "price-ladder" — the visitor picks the price they'd pay for ONE product, so tiers are the brief's price points (4-6, ascending, features: []) and whatYouGet is 3-5 concrete lines of what the product does. Use "tiers" only if the brief has exactly 2-3 packaged plans, and "single-price" only if it has one; never choose them for tone or positioning reasons. title like "What would you pay for this?" subtitle must say plainly that the product is not built yet and that nothing is charged. ctaLabel like "I'd pay this". noPayLabel like "I wouldn't pay for this". askEmail true. followUpQuestion should ask what would make it a must-have. highlightedTierId: the founder's most likely price point / plan.
